...
class DbusSun2000Service(object):
    def __init__(self, servicename, deviceinstance, paths, productname='Huawei Sun2000 PV-Inverter', connection='Sun2000 int. Wifi Modbus'):
        ...
        self._dbusservice.add_path('/ProductId', 1601)  #hopefully free
        ...
        GLib.timeout_add(500, self._update) # pause 500ms before the next request
